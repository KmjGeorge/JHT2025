...
class RotaryEmbedding(Module):
    ...
    def __init__(
            self,
            dim,
            custom_freqs: Tensor or None = None,
...
if __name__ == '__main__':
    ...
    x_withRoPE1 = rope.rotate_queries_or_keys(x)
    x_withRoPE2 = rope.rotate_queries_or_keys(x_inv)
    # x_inv_withRoPE = rope.rotate_queries_or_keys(x_inv)
    print('x :', x.squeeze())
    print(x.squeeze().shape)
    # print('x_inv', x_inv.squeeze())
    print('x_withRoPE1', x_withRoPE1.squeeze())
    print(x_withRoPE1.squeeze().shape)

    print('x_withRoPE2', x_withRoPE2.squeeze())
    print(x_withRoPE2.squeeze().shape)
    # print('x_inv_withRoPE', x_inv_withRoPE.squeeze())
